...
# Vendored for openpf: upstream used `from model.module import *` with a
# sys.path hack. Switched to an explicit relative import so this package
# is self-contained under backend/vendor/kronos. See VENDOR.md.
from .module import *
